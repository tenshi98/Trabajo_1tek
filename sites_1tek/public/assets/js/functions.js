...
function SendDataOptions(Options, jqXHR) {
    ...
    if(typeof Options.DestinoFrom !== 'undefined' && Options.DestinoFrom != null && Options.DestinoFrom!=''){
        ...
        let dataFrom = jsonData.message;
        //redirijo a la nueva ubicacion
        window.location = Options.DestinoFrom + dataFrom;
    }
    ...
    if(typeof Options.showNoti !== 'undefined' && Options.showNoti != null && Options.showNoti!=''){alert(Options.showNoti);}
    //Mueve a otro tab
    ...
    if(typeof Options.Function !== 'undefined' && Options.Function != null && Options.Function!=''){
        //eval(Options.Function + "()");
        let functionObj = window[Options.Function];
        functionObj();
    }
