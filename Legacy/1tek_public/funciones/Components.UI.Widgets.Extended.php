...
function notifications_list($errores){
	...
	if (!empty($errores)) {
		foreach ($errores as $mensaje) {
			...
			$despliegue .= '<p><img src="'.DB_SITE_REPO.'/Legacy/1tek_public/img/icon_'.$tipo.'.png" style="width: 24px;height: 24px;">  '.$error.'</p>';
		}
	}
...
function widget_comunes($com_tras, $Wheater, $NombreUsuario, $Notificacion,$CuentaContactos,$CuentaEventos,$CuentaProgramas){
	...
	<div class="row">
		...
		<script src="'.DB_SITE_REPO.'/Legacy/1tek_public/lib/weather/jquery.simpleWeather.js"></script>
		<script src="'.DB_SITE_REPO.'/Legacy/1tek_public/lib/skycons/skycons.js"></script>
									...
									<div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
										...
										if(isset($enlace)&&$enlace!=''&&$enlace!=0){
											if ($equip['Direccion_img']=='') {
												$GPS .= '<img style="margin-top:10px;" class="media-object img-thumbnail user-img width100" alt="Imagen Referencia" src="'.DB_SITE_REPO.'/Legacy/1tek_public/img/maquina.jpg">';
											}else{
