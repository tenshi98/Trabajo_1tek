	...
	<div class="box noborderbox">
		<header class="header">
			<ul class="nav nav-tabs nav-center">
				...
				<?php if($Tab_2!=0){ ?><li class="active"> <a href="principal_6_2.php"><i class="fa fa-thermometer-half" aria-hidden="true" style="color: #149BFF;"></i> <?php echo $arrOrderTabMenu[2]; ?></a></li><?php } ?>
