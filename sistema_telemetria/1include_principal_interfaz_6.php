	...
	<div class="box noborderbox">
		<header class="header">
			<ul class="nav nav-tabs nav-center">
				...
				<?php if($Tab_2!=0){ ?><li>   <a href="principal_6_2.php"><i class="fa fa-thermometer-half" aria-hidden="true" style="color: #149BFF;"></i> <?php echo $arrOrderTabMenu[2]; ?></a></li><?php } ?>
				<?php if($Tab_1!=0){ ?><li>   <a href="principal_6_1.php"><i class="fa fa-leaf" aria-hidden="true" style="color: #00E676;"></i> <?php echo $arrOrderTabMenu[1]; ?></a></li><?php } ?>
				<?php if($Tab_4!=0){ ?><li>   <a href="principal_6_4.php"><i class="fa fa-leaf" aria-hidden="true" style="color: #00E676;"></i> <?php echo $arrOrderTabMenu[4]; ?></a></li><?php } ?>
				<?php if($Tab_6!=0){ ?><li>   <a href="principal_6_6.php"><i class="fa fa-bolt" aria-hidden="true" style="color: #FFD600;"></i> <?php echo $arrOrderTabMenu[6]; ?></a></li><?php } ?>
				<?php if($Tab_7!=0){ ?><li>   <a href="principal_6_7.php"><i class="fa fa-bolt" aria-hidden="true" style="color: #FFD600;"></i> <?php echo $arrOrderTabMenu[9]; ?></a></li><?php } ?>
        ...
        <div class="tab-content">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fcenter clearfix">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<p class="xtabtext">Bienvenido a 1Tek. Toma decisiones oportunas, rápidas
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fcenter">
				...
				if($Tab_2!=0){
					$colorIcon++;
					if($colorIcon>=5){$colorIcon = 0;}
					$color = ($colorIcon % 2 == 0) ? 'color_9' : 'color_10'; ?>
						...
						<div class="tile <?php echo $color; ?> tile-medium col-xs-12 col-sm-6 col-md-3 col-lg-3"  >
							<div class="tile-content">
								<div class="tile-icon-large">
									<img alt="Imagen Referencia" class="imgw" src="img/icon-c.png">
				...
				<?php if($Tab_1!=0){
					...
					<a href="principal_6_1.php">
						<div class="tile <?php echo $color; ?> tile-medium col-xs-12 col-sm-6 col-md-3 col-lg-3"  >
							<div class="tile-content">
								<div class="tile-icon-large">
									<img alt="Imagen Referencia" class="imgw" src="img/icon-agro-checking.png">
				...
				<?php if($Tab_4!=0){
					...
					<a href="principal_6_4.php">
						<div class="tile <?php echo $color; ?> tile-medium col-xs-12 col-sm-6 col-md-3 col-lg-3"  >
							<div class="tile-content">
								<div class="tile-icon-large">
									<img alt="Imagen Referencia" class="imgw" src="img/icon-agro-weather.png">
				...
				<?php if($Tab_6!=0){
					...
					<a href="principal_6_6.php">
						<div class="tile <?php echo $color; ?> tile-medium col-xs-12 col-sm-6 col-md-3 col-lg-3"  >
							<div class="tile-content">
								<div class="tile-icon-large">
									<img alt="Imagen Referencia" class="imgw" src="img/icon-power-crane.png">
				...
				<?php if($Tab_7!=0){
					...
					<a href="principal_6_7.php">
						<div class="tile <?php echo $color; ?> tile-medium col-xs-12 col-sm-6 col-md-3 col-lg-3"  >
							<div class="tile-content">
								<div class="tile-icon-large">
									<img alt="Imagen Referencia" class="imgw" src="img/icon-power-energy.png">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fcenter clearfix">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<br/>
					<p class="xtabtext">
						Si tienes alguna consulta con tu servicio contratado, puedes escribirnos a <a href="mailto:soporte@1tek.cl">soporte@1tek.cl</a> y responderemos rápidamente a tus preguntas.
					</p>
				</div>
			</div>
...
<?php widget_whatsappFloatBtn('+56941933222', 'Necesito un poco de información'); ?>
