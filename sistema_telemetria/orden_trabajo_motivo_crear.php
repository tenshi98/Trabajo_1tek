					...
					if (isset($_SESSION['ot_motivo_tareas'])){
						foreach ($_SESSION['ot_motivo_tareas'] as $key => $trabajos){
							...
							<tr class="item-row linea_punteada">
								...
								<td>
									<div class="btn-group" style="width: 35px;" >
										<a onClick="dialogBox(\''.$ubicacion.'&del_tarea=true\', \''.$dialogo.'\')" title="Borrar Trabajo" class="btn btn-danger btn-sm tooltip"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
									</div>
								</td>
							</tr>';
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group" style="width: 175px;" >
								...
								<?php if ($rowlevel['level']>=3){ ?><a href="<?php echo $location.'&cancel='.$ot['idOT']; ?>" title="Cancelar Orden de Trabajo" class="btn btn-danger btn-sm tooltip"><i class="fa fa-ban" aria-hidden="true"></i></a><?php } ?>
