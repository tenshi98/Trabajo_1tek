							...
							<tr class="item-row linea_punteada">
								...
								<td>
									<div class="btn-group" style="width: 35px;" >
										...
										<a onClick="dialogBox('<?php echo $ubicacion ?>', '<?php echo $dialogo ?>')" title="Borrar Maquina" class="btn btn-danger btn-sm tooltip"><i class="fa fa-trash-o" aria-hidden="true"></i></a>							
									</div>
								</td>
							</tr>
						<?php }
