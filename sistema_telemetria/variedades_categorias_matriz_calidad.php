...
$location = $original;
$new_location = "variedades_categorias_matriz_calidad.php";
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'variedades_categorias_matriz_calidad.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" >Matriz Calidad</a></li>
				<li class="dropdown">
