...
class main extends ControllerWeb {
    ...
    public function index($f3){
        ...
        $Footer = [
            'Titulo'      => 'Contacto',
            'Subtitulo'   => 'Contáctanos por los siguientes medios',
            'Pie'         => 'Todos los derechos reservados.',
            'socialLinks' => [
                ['class'  => 'twitter',   'iclass' => 'bi bi-twitter',   'Link'   => ''],
                ['class'  => 'facebook',  'iclass' => 'bi bi-facebook',  'Link'   => ''],
                ['class'  => 'instagram', 'iclass' => 'bi bi-instagram', 'Link'   => ''],
                ['class'  => 'linkedin',  'iclass' => 'bi bi-linkedin',  'Link'   => ''],
            ],
            'LinksTitulo' => 'Enlaces de Interes',
            'Links' => [
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
            ],
            'ServicesTitulo' => 'Servicios',
            'Services' => [
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
                ['iclass' => 'bx bx-chevron-right', 'Link' => '', 'Text'  => 'Home'],
        ...
        $f3->data = [
            ...
            'PagePreview'     => 'https://web.1tek.cl/assets/img/PagePreview.jpg',
            'PageDirection'   => 'A108 Adam Street <br>NY 535022, USA<br>',
            'PagePhone'       => '+1 5589 55488 55',
            'PageEmail'       => 'contacto@1tek.cl',
    ...
    public function sendMail(){
        ...
        $Cadena  = '';
        if (!empty($_POST['Nombre'])) {    $Cadena .= 'Nombre: '.htmlspecialchars($_POST['Nombre'], ENT_QUOTES, 'UTF-8');}
        if (!empty($_POST['Email'])) {     $Cadena .= '<br/>Email:'.htmlspecialchars($_POST['Email'], ENT_QUOTES, 'UTF-8');}
        if (!empty($_POST['Mensaje'])) {   $Cadena .= '<br/>Mensaje:'.htmlspecialchars($_POST['Mensaje'], ENT_QUOTES, 'UTF-8');}

        /************************************************/
        //se genera el POST
        $arrData = [
            'Hacia'   => 'contacto@1tek.cl',
            'Asunto'  => 'Contacto Web',
            'Mensaje' => $Cadena,
        ];
        /******************************/
