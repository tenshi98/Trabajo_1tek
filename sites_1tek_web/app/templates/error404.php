    ...
    <head>
        ...
        <style>
            * {-webkit-box-sizing: border-box;box-sizing: border-box;}
            ...
            .notfound h2 {font-family: 'Cabin', sans-serif;font-size: 33px;font-weight: 700;text-transform: uppercase;letter-spacing: 7px;}
    ...
    <body>
        <div id="notfound">
            <div class="notfound">
                ...
                <p>La pagina que intentas ver no existe.</p>
                <a href="<?php echo $BASE.'/index'; ?>">Volver al inicio</a>
            </div>
        </div>
    </body>
</html>