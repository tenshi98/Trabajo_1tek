...
/*                                Cloro Walnmar           /*
/*********************************************************************/
//$Equipos_Ex = array('255'); //se tiene que re calibrar de la paloma los siguentes: 63,147 y 142
//verifico si el dato ingresado existe dentro de las opciones
//if (in_array($Identificador, $Equipos_Ex)) {
	//Compru
	//switch ($Identificador) {
		...
		//case 255: //Cloro
			//$cloro = $Sensor[1]['valor']*0.00526134;
			//$Sensor[1]['valor'] = floatval(number_format($cloro, 3, '.', ''));
			//break;
