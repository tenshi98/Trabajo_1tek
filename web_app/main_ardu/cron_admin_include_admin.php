...
switch ($TipoEnvio) {
    ...
    case 1:
		...
		try {
			...
			$EmailCuerpo .= '</p>';
			$EmailCuerpo .= '<a href="https://clientes.1tek.cl/informe_administrador_07_to_excel.php?f_inicio='.$FechaInicio.'&h_inicio='.$HoraInicio.'&f_termino='.$FechaTermino.'&h_termino='.$HoraTermino.'&idSistema=1&idTipoUsuario=1&submit_filter=Filtrar" style="display:block;width:100%;text-align: center;font-size: 20px;text-decoration: none;color: #004AAD;"><strong>Descargar &#8594;</strong></a>';
			$EmailCuerpo .= '</div>';
    ...
    case 4:
		...
		$Message_Whatsapp .= '<br/>';
		$Message_Whatsapp .= 'https://clientes.1tek.cl/informe_administrador_07_to_excel.php?f_inicio='.$FechaInicio.'&h_inicio='.$HoraInicio.'&f_termino='.$FechaTermino.'&h_termino='.$HoraTermino.'&idSistema=1&idTipoUsuario=1&submit_filter=Filtrar';
